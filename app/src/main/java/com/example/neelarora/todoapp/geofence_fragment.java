...
public class geofence_fragment extends DialogFragment {
        ...
        builder.setView(view)
                ...
                .setNegativeButton(R.string.Cancel, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        geofence_fragment.this.getDialog().cancel();

                        if (listener != null) {
                            listener.onDialogNegativeClick(geofence_fragment.this);
                        }
                    }
                });
                ...
                positiveButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if (dataIsValid()) {
                            ...
                            if (listener != null) {
                                listener.onDialogPositiveClick(geofence_fragment.this, geofence);
                                dialog.dismiss();
                            }
                        } else {
